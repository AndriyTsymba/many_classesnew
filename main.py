...
class School:
    ...
    def get_school_statistic(self):
        ...
        if num_student == 0:
            ...
            avd_grade = sum(student.grade for student in self.students) / num_student
            return f" на {num_student} студентів середня оцінка по школі"
